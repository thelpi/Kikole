...
namespace KikoleSiteUnitTests
{
    ...
    internal sealed class UserRequestBuilder
    {
        ...
        internal UserRequestBuilder WithLogin(string login) { _request.Login = login; return this; }

        internal UserRequestBuilder WithPassword(string password) { _request.Password = password; return this; }

        internal UserRequestBuilder WithRecovery(string? question, string? answer)
        {
            _request.PasswordResetQuestion = question;
            _request.PasswordResetAnswer = answer;
            return this;
        }

        internal UserRequestBuilder WithLanguage(Languages? language) { _request.Language = language; return this; }

        internal UserRequestBuilder WithIp(string? ip) { _request.Ip = ip; return this; }
    ...
    {
        private readonly PlayerSubmissionValidationRequest _request;
            ...
            string? clueFr = "indice", string? easyClueFr = "indice facile")
        {
            ...
            _request.ClueEditLanguages = new Dictionary<Languages, string?> { { Languages.fr, clueFr } };
            _request.EasyClueEditLanguages = new Dictionary<Languages, string?> { { Languages.fr, easyClueFr } };
            return this;
        }
        ...
        {
            _request.ClueEditLanguages = clues;
            return this;
        }
