...
public class PlayerSubmissionValidationRequestTests
{
    ...
    {
        var request = Accepted() with { PlayerId = 0 };
    ...
    {
        var request = Accepted() with { ClueEditLanguages = new Dictionary<Languages, string?>() };
    ...
    {
        var request = Accepted() with { ClueEditLanguages = new Dictionary<Languages, string?> { { Languages.fr, "   " } } };
    ...
    {
        var request = Accepted() with { EasyClueEditLanguages = new Dictionary<Languages, string?>() };
